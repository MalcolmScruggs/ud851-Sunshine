...
//      TODO (7) Generate a weather summary with the date, description, high and low
        ...
        int descripId = mCursor.getInt(MainActivity.INDEX_WEATHER_CONDITION_ID);
        String description = SunshineWeatherUtils.getStringForWeatherCondition(mContext, descripId);
        ...
        String highAndLow = SunshineWeatherUtils.formatHighLows(mContext, highInCelcius, lowInCelcius);

        String summary = dateString + " - " + description + " - " + highAndLow;
